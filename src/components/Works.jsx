      ...
      <div>
        ...
        <div className="w-full flex">
          <motion.p
            ...
            A few selected projects I’m genuinely proud of — chosen for depth
            over count. Each one highlights the architecture and engineering
            behind it, with links to a live demo (and the source, where it’s
            public).
          </motion.p>
        </div>

        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-7 justify-items-center max-w-[800px] mx-auto">
        ...
        <div className="w-full flex flex-col items-center justify-center">
          <p className="mt-24 text-secondary text-[21px] max-w-3xl leading-[30px] text-center">
            Curious to dig deeper? More of my code and experiments live on
